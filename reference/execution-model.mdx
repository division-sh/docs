...
**dependency graph** and commits the whole thing in one transaction. Most surprises when
authoring handlers come from not knowing that order, or from one field quietly overriding
another. This page is the precise model.
...
This is where the foot-guns are. Read these as a unit:
